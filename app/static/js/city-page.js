...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    bannerTitle.textContent = citySelect;
    bannerTitle.classList.add('animate-Up-Back');
    previewTitle.textContent = `Explore Events Places in ${citySelect}`;


    eventPlaceRecords = eventPlaceRecords.filter(record => record.location === citySelect);
